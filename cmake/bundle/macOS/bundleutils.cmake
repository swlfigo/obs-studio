...
if(EXISTS
  ...
  foreach(_SUFFIXES ${CEF_HELPER_APP_SUFFIXES})
    ...
    set(_HELPER_ENTITLEMENT_PLIST
        "entitlements-helper${_PLIST_SUFFIX}.plist")
    ...
    execute_process(
      COMMAND
        /usr/bin/codesign --force --sign "${_CODESIGN_IDENTITY}" --deep --options
        runtime --entitlements "${_CODESIGN_ENTITLEMENTS}/entitlements-helper${_PLIST_SUFFIX}.plist"
        "${CMAKE_INSTALL_PREFIX}/${_BUNDLENAME}/Contents/Frameworks/OBS Helper${_NAME_SUFFIX}.app"
        ${_VERBOSE_FLAG} ${_QUIET_FLAG})
  endforeach()
endif()
  ...
  if(NOT IS_SYMLINK "${_DEPENDENCY}")
    ...
    execute_process(
      COMMAND
        ...
        runtime --entitlements "${_CODESIGN_ENTITLEMENTS}/entitlements.plist" "${_DEPENDENCY}"
        ${_VERBOSE_FLAG} ${_QUIET_FLAG})
  endif()
endforeach()
